...
echo 2k > /sys/kernel/debug/gpio_debug/gpio48/current_pullstrength
...
echo 2k > /sys/kernel/debug/gpio_debug/gpio41/current_pullstrength
...
echo 2k > /sys/kernel/debug/gpio_debug/gpio43/current_pullstrength
